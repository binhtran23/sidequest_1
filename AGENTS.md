...
- `experiments/<experiment-id>/` holds local configuration, reports, and promotion evidence. Experiment-run directories are Git-ignored; publish reviewed findings through the root `README.md`.
